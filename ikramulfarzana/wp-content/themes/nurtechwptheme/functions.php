...
function twentyseventeen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widget One', 'twentyseventeen' ),
		'id'            => 'footerwidgetone',
		'description'   => __( 'Add widgets here to appear in your footer.', 'twentyseventeen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widget Two', 'twentyseventeen' ),
		'id'            => 'footerwidgetwo',
		'description'   => __( 'Add widgets here to appear in your footer.', 'twentyseventeen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widget Three', 'twentyseventeen' ),
		'id'            => 'footerwidgethree',
		'description'   => __( 'Add widgets here to appear in your footer.', 'twentyseventeen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widget Four', 'twentyseventeen' ),
		'id'            => 'footerwidgefour',
		'description'   => __( 'Add widgets here to appear in your footer.', 'twentyseventeen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
...
// Character Limiter
function custom_content_truncate($string, $number_of_character, $dot_option = true, $type = 'word'){
	$string = strip_tags($string);
	if($type == 'word'){
		$words = explode(' ', $string);
		$new_string = '';
		foreach($words as $word){
			if((strlen($new_string) <= $number_of_character) && strlen($word) <= $number_of_character){
				if(!empty($new_string)){
					if((strlen($new_string)+strlen($word)+1)<$number_of_character){
						$new_string .= ' '.$word;
					}else{
		...
		return substr($string,0,$number_of_character);
	}
}
...
function latest_newspost(){
	echo '<div class="time-line-group">';
	$the_query = new WP_Query( 'showposts=6' );
	while ($the_query -> have_posts()) : $the_query -> the_post();
		$thumb_img = get_post_thumbnail_id(get_the_ID());
		...
		<div class="time-line-item">
                            ...
                            <div class="time-line-item-body">
                                <h3><a href="<?php the_permalink(); ?>"><?php echo custom_content_truncate(strip_tags($content_title),70, false).'...'; ?></a></h3>
                                <p><?php echo custom_content_truncate(strip_tags($content),130, false).'...'; ?><a href="<?php the_permalink(); ?>">Details</a></p>
                            </div>
                        </div>
		<?php
	endwhile;
